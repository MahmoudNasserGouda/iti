...
namespace WebApplication1.Migrations
{
    ...
    [Migration("20230619181613_MyMigration")]
            ...
            modelBuilder.Entity("WebApplication1.Models.Entities.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("Date")
                        ...
                        .HasDefaultValue(new DateTime(2023, 6, 19, 20, 16, 12, 683, DateTimeKind.Local).AddTicks(3866));
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ChapterID = 1,
                            Date = new DateTime(2023, 6, 19, 20, 16, 12, 684, DateTimeKind.Local).AddTicks(2408),
                        ...
                        new
                        {
                            ID = 2,
                            ChapterID = 1,
                            Date = new DateTime(2023, 6, 19, 20, 16, 12, 684, DateTimeKind.Local).AddTicks(2416),
                        ...
                        new
                        {
                            ID = 3,
                            ChapterID = 1,
                            Date = new DateTime(2023, 6, 19, 20, 16, 12, 684, DateTimeKind.Local).AddTicks(2419),
                            Text = "Not bad",
                            UserID = "1",
                            Votes = 5
                        },
                        new
                        {
                            ID = 4,
                            ChapterID = 1,
                            Date = new DateTime(2023, 6, 19, 20, 16, 12, 684, DateTimeKind.Local).AddTicks(2421),
            ...
            modelBuilder.Entity("WebApplication1.Models.Entities.Review", b =>
                {
                    ...
                    b.Property<DateTime>("Date")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 6, 19, 20, 16, 12, 684, DateTimeKind.Local).AddTicks(3513));
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            BookID = 1,
                            Date = new DateTime(2023, 6, 19, 20, 16, 12, 684, DateTimeKind.Local).AddTicks(7810),
                            Rating = 3,
                        ...
                        new
                        {
                            ID = 2,
                            BookID = 1,
                            Date = new DateTime(2023, 6, 19, 20, 16, 12, 684, DateTimeKind.Local).AddTicks(7819),
                            Rating = 4,
            ...
            modelBuilder.Entity("WebApplication1.Models.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "c59c6456-7c84-482e-bbaf-791eec6fb8c5",
                            ...
                            SecurityStamp = "6e50d7fb-a3f3-4268-bc7b-cb6ff2cdd365",
