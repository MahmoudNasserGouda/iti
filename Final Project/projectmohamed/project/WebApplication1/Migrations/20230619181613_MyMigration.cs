        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 6, 19, 20, 16, 12, 684, DateTimeKind.Local).AddTicks(3513)),
                    BookID = table.Column<int>(type: "int", nullable: false),
                    UserID = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Text = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Votes = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 6, 19, 20, 16, 12, 683, DateTimeKind.Local).AddTicks(3866)),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "1", 0, "c59c6456-7c84-482e-bbaf-791eec6fb8c5", "Mahmoud@gmail.com", false, false, null, "MAHMOUD@GMAIL.COM", "MAHMOUD", "1245", null, false, "6e50d7fb-a3f3-4268-bc7b-cb6ff2cdd365", false, "Mahmoud" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "H. P. Lovecraft", 1, "The Call of Cthulhu is a short story by American writer H. P. Lovecraft. Written in the summer of 1926, it was first published in the pulp magazine Weird Tales in February 1928.", "https://m.media-amazon.com/images/I/515TltJSPEL.jpg", "The Call of Cthulhu", 19.989999999999998, "1928" },
            ...
            migrationBuilder.InsertData(
                table: "Chapters",
                columns: new[] { "ID", "BookID", "Content", "Title" },
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2023, 6, 19, 20, 16, 12, 684, DateTimeKind.Local).AddTicks(7810), 3, "Very amusing book", "1", 10 },
                    { 2, 1, new DateTime(2023, 6, 19, 20, 16, 12, 684, DateTimeKind.Local).AddTicks(7819), 4, "Very creative writing", "1", 5 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2023, 6, 19, 20, 16, 12, 684, DateTimeKind.Local).AddTicks(2408), "Great chapter, very scary", "1", -1 },
                    { 2, 1, new DateTime(2023, 6, 19, 20, 16, 12, 684, DateTimeKind.Local).AddTicks(2416), "Bad Chapter, very scary for me", "1", 3 },
                    { 3, 1, new DateTime(2023, 6, 19, 20, 16, 12, 684, DateTimeKind.Local).AddTicks(2419), "Not bad", "1", 5 },
                    { 4, 1, new DateTime(2023, 6, 19, 20, 16, 12, 684, DateTimeKind.Local).AddTicks(2421), "Didn't meet my expectations to be honest", "1", 2 }
                });
