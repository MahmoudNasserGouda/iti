        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 6, 18, 20, 47, 41, 71, DateTimeKind.Local).AddTicks(1911)),
                    BookID = table.Column<int>(type: "int", nullable: false),
                    UserID = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Text = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Votes = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 6, 18, 20, 47, 41, 70, DateTimeKind.Local).AddTicks(6635)),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "1", 0, "28094bf2-a343-4fce-8ea9-24c071afbeab", "Mahmoud@gmail.com", false, false, null, "MAHMOUD@GMAIL.COM", "MAHMOUD", "1245", null, false, "015d663b-1fce-4721-bfbf-b4672ac5a251", false, "Mahmoud" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2023, 6, 18, 20, 47, 41, 71, DateTimeKind.Local).AddTicks(4300), 3, "Very amusing book", "1", 10 },
                    { 2, 1, new DateTime(2023, 6, 18, 20, 47, 41, 71, DateTimeKind.Local).AddTicks(4310), 4, "Very creative writing", "1", 5 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2023, 6, 18, 20, 47, 41, 71, DateTimeKind.Local).AddTicks(1330), "Great chapter, very scary", "1", -1 },
                    { 2, 1, new DateTime(2023, 6, 18, 20, 47, 41, 71, DateTimeKind.Local).AddTicks(1339), "Bad Chapter, very scary for me", "1", 3 },
                    { 3, 1, new DateTime(2023, 6, 18, 20, 47, 41, 71, DateTimeKind.Local).AddTicks(1342), "Not bad", "1", 5 },
                    { 4, 1, new DateTime(2023, 6, 18, 20, 47, 41, 71, DateTimeKind.Local).AddTicks(1344), "Didn't meet my expectations to be honest", "1", 2 }
                });
