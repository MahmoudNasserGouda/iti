...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication1.Models.Entities.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("Date")
                        ...
                        .HasDefaultValue(new DateTime(2023, 6, 27, 14, 41, 31, 664, DateTimeKind.Local).AddTicks(8856));
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ChapterID = 1,
                            Date = new DateTime(2023, 6, 27, 14, 41, 31, 665, DateTimeKind.Local).AddTicks(630),
                        ...
                        new
                        {
                            ID = 2,
                            ChapterID = 1,
                            Date = new DateTime(2023, 6, 27, 14, 41, 31, 665, DateTimeKind.Local).AddTicks(643),
                        ...
                        new
                        {
                            ID = 3,
                            ChapterID = 1,
                            Date = new DateTime(2023, 6, 27, 14, 41, 31, 665, DateTimeKind.Local).AddTicks(646),
                            Text = "Not bad",
                            UserID = "1",
                            Votes = 5
                        },
                        new
                        {
                            ID = 4,
                            ChapterID = 1,
                            Date = new DateTime(2023, 6, 27, 14, 41, 31, 665, DateTimeKind.Local).AddTicks(648),
            ...
            modelBuilder.Entity("WebApplication1.Models.Entities.Review", b =>
                {
                    ...
                    b.Property<DateTime>("Date")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 6, 27, 14, 41, 31, 665, DateTimeKind.Local).AddTicks(1088));
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            BookID = 1,
                            Date = new DateTime(2023, 6, 27, 14, 41, 31, 665, DateTimeKind.Local).AddTicks(2986),
                            Rating = 3,
                        ...
                        new
                        {
                            ID = 2,
                            BookID = 1,
                            Date = new DateTime(2023, 6, 27, 14, 41, 31, 665, DateTimeKind.Local).AddTicks(2999),
                            Rating = 4,
            ...
            modelBuilder.Entity("WebApplication1.Models.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "671d4a9a-c1c0-4369-8bde-f26242c39143",
                            ...
                            SecurityStamp = "7739610e-f30a-4de7-8646-408a8d4eb1dd",
                            TwoFactorEnabled = false,
                            UserName = "Mahmoud"
                        });
                });

            modelBuilder.Entity("WebApplication1.Models.Entities.UserComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebApplication1.Models.Entities.UserComment", b =>
                {
                    b.HasOne("WebApplication1.Models.Entities.Comment", "Comment")
                        .WithMany("Voters")
            ...
            modelBuilder.Entity("WebApplication1.Models.Entities.UserReview", b =>
                {
                    b.HasOne("WebApplication1.Models.Entities.Review", "Review")
                        .WithMany("Voters")
