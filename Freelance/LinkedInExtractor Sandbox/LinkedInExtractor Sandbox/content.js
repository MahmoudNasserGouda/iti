      ...
      async function addButton() {
        ...
        if (slider == null) {
          ...
          if (buttonBar) {
            ...
            Promise.all([
            ...
            ]).then(async ([fullName, about, experiences, headline, url, contactInfo]) => {
              ...
              await addProfile(fullName, about, experiences, headline, url, contactInfo.phone, contactInfo.email)
...
async function addProfile(fullName, about, experiences, headline, url, mobile, email) {
