  ...
  if (window.location.href.startsWith("https://www.linkedin.com/in/")) {
    ...
    function addButton() {
      ...
      if (buttonBar) {
        ...
        Promise.all([
        ...
        ]).then(([fullName, about, experiences, headline, url, imgurl, contactInfo]) => {
          ...
          addProfile(fullName, about, experiences, headline, url, contactInfo.phone, imgurl, contactInfo.email)
...
function addProfile(fullName, about, experiences, headline, url, mobile, imgurl, email) {
...
function extractExperiences() {
  console.log('extractExperiences');
  let experiences = '';
